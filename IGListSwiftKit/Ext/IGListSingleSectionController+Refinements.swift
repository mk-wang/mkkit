...
public extension ListSingleSectionController {
    /**
     ...
     */
    convenience init<Item, Cell: UICollectionViewCell>(
    ...
    /**
      ...
      (usually `self`) or the `ListAdapter`. Pass in locally scoped objects or use `weak` references!
     */
    convenience init<Value: ListIdentifiable, Cell: UICollectionViewCell>(
